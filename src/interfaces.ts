...
export type ReceivedEvent = BalanceRequestedEvent | InGameCurrencyDepositEvent | NftLinkStatusChangedEvent | BadTokenEvent | WithdrawalEvent | PingEvent | RollbackWithdrawalEvent;
